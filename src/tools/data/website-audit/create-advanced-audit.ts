  ...
  registerTool(server: McpServer): void {
    server.registerTool(
      this.toolName('createAdvancedAudit'),
      {
        ...
        description:
          'Data Tool: Launches an advanced website audit that renders JavaScript before analyzing the page. Suitable for Single-Page Applications (SPAs) or dynamic content. For static or server-side-rendered sites, prefer createStandardAudit (cheaper, faster).',
        inputSchema: {

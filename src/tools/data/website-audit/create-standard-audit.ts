  ...
  registerTool(server: McpServer): void {
    server.registerTool(
      this.toolName('createStandardAudit'),
      {
        ...
        description:
          'Data Tool: Launches a standard website audit that crawls the HTML of a website. Suitable for most static and server-side rendered sites. For JavaScript-rendered sites (SPAs), use createAdvancedAudit instead.',
        inputSchema: {

...
export class GetKeywordStats extends BaseTool {
    ...
    registerTool(server) {
        server.registerTool(this.toolName('getKeywordStats'), {
        ...
        }, async ({ site_id, ...params }) => this.makeGetRequest(`/sites/${site_id}/positions`, params));
    }
}
//# sourceMappingURL=get-keyword-stats.js.map
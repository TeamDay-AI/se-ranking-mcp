...
export class UpdateLlmEngine extends BaseTool {
    ...
    registerTool(server) {
        server.registerTool(this.toolName('updateLlmEngine'), {
            ...
            inputSchema: {
                ...
                region_name: z
                    ...
                    .nullable()
                    .optional()
                    .describe('Canonical SERP location name (e.g. "Los Angeles, California, United States"). Must match exactly a value returned by DATA_getSerpLocations — abbreviated forms like "Los Angeles, CA, USA" are rejected with HTTP 400 "Invalid region name". Set to null to clear.'),
...
//# sourceMappingURL=update-llm-engine.js.map
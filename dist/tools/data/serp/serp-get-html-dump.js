...
export class GetSerpHtmlDump extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getSerpHtmlDump'), {
            ...
            description: 'Data Tool: Retrieves the raw HTML dump of a completed SERP task as a ZIP file. Returns binary ZIP data containing the SERP HTML page(s). Useful for debugging, archiving, or parsing the actual SERP page content.',
            inputSchema: {
                task_id: z
                    .number()
                    .int()

...
export class CreateAdvancedAudit extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('createAdvancedAudit'), {
            ...
            description: 'Data Tool: Launches an advanced website audit that renders JavaScript before analyzing the page. Suitable for Single-Page Applications (SPAs) or dynamic content.',
            inputSchema: {

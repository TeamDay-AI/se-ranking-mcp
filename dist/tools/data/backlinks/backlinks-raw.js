...
export class GetBacklinksRaw extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getBacklinksRaw'), {
            title: 'Fetch Backlinks in Batches',
            description: 'Data Tool: Returns all backlinks pointing to a target using cursor-based pagination for large datasets.',
            inputSchema: {
                target: z
                    .string()
                ...
                next: z
                    .string()
                    .optional()
                    .describe('Cursor for the next page of results. Do NOT include for the first request.'),
                output: z
                    .enum(OUTPUT_FORMATS)
                    .optional()
                    .default('json')
                ...
                order_by: z
                    ...
                    .optional()
                    .default('date_found')
                    .describe("Sort field: 'date_found' (most recent), 'first.domain_inlink_rank', or 'first.inlink_rank'."),
                per_domain: z
                    .number()
                    .int()
                    .positive()
                    ...
                    .max(100)
                    .optional()
                    .describe('Number of backlinks per referring domain to return. If omitted, returns all.'),
            },
        }, async (params) => this.makeGetRequest('/v1/backlinks/raw', params));
    }
}
//# sourceMappingURL=backlinks-raw.js.map
...
export class GetAllBacklinks extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getAllBacklinks'), {
            title: 'Backlinks All',
            description: 'Data Tool: Retrieves a comprehensive list of backlinks for the specified target, with extensive filtering and sorting options.',
            inputSchema: {
                target: z
                    .string()
                ...
                per_domain: z
                    ...
                    .max(100)
                    .optional()
                    .describe('Number of backlinks per referring domain to return. If omitted, returns all backlinks (may exceed 100).'),
                output: z
                    .enum(OUTPUT_FORMATS)
                    .optional()
                    .default('json')
                ...
                order_by: z
                    ...
                    .optional()
                    .default('date_found')
                    .describe("Sort field: 'date_found' (most recent first), 'first.domain_inlink_rank', or 'first.inlink_rank'."),
                inlink_rank_from: z
                    .number()
                    .int()
                    .positive()
                ...
                nofollow_filter: z
                    ...
                    .optional()
                    .describe("Backlink type filter: 'nofollow_only' or 'dofollow_only'. If omitted, returns all."),
            },
        }, async (params) => this.makeGetRequest('/v1/backlinks/all', params));
    }
}
//# sourceMappingURL=backlinks-all.js.map
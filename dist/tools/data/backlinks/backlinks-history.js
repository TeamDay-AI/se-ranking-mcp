...
export class ListNewLostBacklinks extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('listNewLostBacklinks'), {
            title: 'List New and Lost Backlinks',
            description: 'Data Tool: Returns a list of backlinks (newly) found or lost within the specified date range for the specified target.',
            inputSchema: {
                target: z
                    .string()
                ...
                dofollow: z
                    ...
                    .optional()
                    .describe("Attribute: 'dofollow', 'nofollow', or 'undefined'. Omit for all."),
                url_from: z
                    .string()
                    .optional()
                ...
                order_by: z
                    ...
                    .describe("Sort by: 'new_lost_date' (recency), 'domain_inlink_rank', or 'inlink_rank'."),
                output: z
                    .enum(OUTPUT_FORMATS)
                    .optional()
                    .default('json')
...
//# sourceMappingURL=backlinks-history.js.map
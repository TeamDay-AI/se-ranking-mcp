...
export class GetBacklinksAuthority extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getBacklinksAuthority'), {
            title: 'Backlinks Authority',
            description: 'Data Tool: Fetch authority metrics for a target (domain, host or URL) (v1/backlinks/authority)',
            inputSchema: {
                target: z
                    .string()
...
//# sourceMappingURL=backlinks-authority.js.map
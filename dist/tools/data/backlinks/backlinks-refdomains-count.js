...
export class GetTotalRefDomainsCount extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getTotalRefDomainsCount'), {
            title: 'Get Total Referring Domains Count',
            description: 'Data Tool: Returns the number of unique domains linking to a target. Supports batch requests.',
            inputSchema: {
                target: z
                    .union([
                    ...
                    .describe('Target to analyze: root domain, host (subdomain), or URL. Can be a single string or an array.'),
                mode: z
                    .enum(MODES)
                    .optional()
                    .default('host')
...
//# sourceMappingURL=backlinks-refdomains-count.js.map
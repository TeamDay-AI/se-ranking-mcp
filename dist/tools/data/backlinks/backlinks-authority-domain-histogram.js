...
export class GetDomainAuthorityHistogram extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getDomainAuthorityHistogram'), {
            title: 'Get Domain Authority Histogram',
            description: 'Data Tool: Returns a bucketed histogram of Domain InLink Rank (Domain Authority) for referring domains linking to the target.',
            inputSchema: {
...
//# sourceMappingURL=backlinks-authority-domain-histogram.js.map
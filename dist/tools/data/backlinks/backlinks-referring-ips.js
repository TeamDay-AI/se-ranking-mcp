...
export class GetReferringIps extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getReferringIps'), {
            title: 'Get Referring IPs',
            description: 'Data Tool: Returns information about IPv4 addresses that belong to backlinks that point to a target.',
            inputSchema: {
...
//# sourceMappingURL=backlinks-referring-ips.js.map
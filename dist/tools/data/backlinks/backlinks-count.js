...
export class GetBacklinksCount extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getBacklinksCount'), {
            title: 'Get Total Backlinks Count',
            description: 'Data Tool: Returns the total number of backlinks for the target. Supports batch requests.',
            inputSchema: {
                target: z
                    .union([
...
//# sourceMappingURL=backlinks-count.js.map
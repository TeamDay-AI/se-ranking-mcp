...
export class GetBacklinksAnchors extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getBacklinksAnchors'), {
            title: 'Backlinks Anchors',
            description: 'Data Tool: Retrieves a list of anchor texts for backlinks pointing to the specified target, with sorting and limit options.',
            inputSchema: {
                target: z
                    .string()
                ...
                order_by: z
                    ...
                    .optional()
                    .default('backlinks')
                    .describe("Sort field (descending): 'backlinks' = total backlinks using the anchor; 'refdomains' = total referring domains using the anchor."),
                limit: z
                    .number()
                    .int()
                    .positive()
...
//# sourceMappingURL=backlinks-anchors.js.map
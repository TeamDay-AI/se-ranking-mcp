...
export class GetNewLostBacklinksCount extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getNewLostBacklinksCount'), {
            title: 'Get Daily New and Lost Backlinks Count',
            description: 'Data Tool: Returns a number of (newly) found or lost backlinks for every day within the specified date range.',
            inputSchema: {
                target: z
                    .string()
                ...
                new_lost_type: z
                    .enum(['new', 'lost'])
                    .optional()
                    .describe("Indicates whether to count 'new' or 'lost'. Omit for both."),
                date_from: z
                    .string()
                    .optional()
...
//# sourceMappingURL=backlinks-history-count.js.map
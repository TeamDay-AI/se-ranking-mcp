...
export class GetDistributionOfDomainAuthority extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getDistributionOfDomainAuthority'), {
            title: 'Get Distribution of Domain Authority',
            description: 'Data Tool: Returns information about the distribution of Domain InLink Rank (Domain Authority) of all the domains that reference a specific target.',
            inputSchema: {
...
//# sourceMappingURL=backlinks-authority-domain-distribution.js.map
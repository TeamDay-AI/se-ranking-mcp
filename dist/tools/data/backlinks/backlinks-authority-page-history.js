...
export class GetPageAuthorityHistory extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getPageAuthorityHistory'), {
            title: 'Get Page Authority History',
            description: 'Data Tool: Returns information about the historical values of InLink Rank for a specific target page.',
            inputSchema: {
...
//# sourceMappingURL=backlinks-authority-page-history.js.map
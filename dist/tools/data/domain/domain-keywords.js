...
export class GetDomainKeywords extends BaseTool {
    ...
    registerTool(server) {
        server.registerTool(this.toolName('getDomainKeywords'), {
            title: 'Domain Keywords',
            description: 'Data Tool: Retrieves a list of keywords for which a domain ranks in organic or paid search.',
            inputSchema: {
                source: z
                    .string()
                ...
                cols: z
                    .string()
                    .optional()
                    .refine((val) => this.isValidCommaSeparatedList(this.COLS, val), {
                ...
                filter_intents: z
                    .string()
                    .optional()
                    .refine((val) => this.isValidCommaSeparatedList(INTENTS, val), {
                ...
                with_subdomains: z
                    ...
                    .optional()
                    .default(true)
                    .describe('If set to true, includes keywords ranking for the specified domain or URL and all its subdomains.'),
                filter_keyword: z
                    .string()
                    .optional()
                ...
                filter_serp_features: z
                    .string()
                    .optional()
                    .describe('Comma-separated list of SERP feature codes to include (e.g., featured_snippet,local_pack,sitelinks). Filters keywords where the SERP feature exists on the SERP (keyword-level).'),
                filter_serp_features_2_mode: z
                    .enum(['with_link', 'without_link'])
                    .optional()
                    .describe('SERP feature linking mode. "with_link" returns keywords where the analyzed domain IS referenced within the specified SERP feature. "without_link" returns keywords where it is NOT. Must be used together with filter_serp_features_2_value.'),
                filter_serp_features_2_value: z
                    .string()
                    .optional()
                    .describe('The SERP feature code to check for domain linking (e.g., "sge" for AI Overview, "reviews", "featured_snippet"). Must be used together with filter_serp_features_2_mode.'),
            },
...
//# sourceMappingURL=domain-keywords.js.map
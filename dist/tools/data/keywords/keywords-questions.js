...
export class GetKeywordQuestions extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getKeywordQuestions'), {
            ...
            inputSchema: {
                ...
                filter_serp_features: z
                    .string()
                    .optional()
                    .refine((val) => this.isValidCommaSeparatedList(SERP_FEATURE_CODES, val), {
                    message: 'filter_serp_features must be a comma-separated list of supported SERP feature codes',
                })
                ...
                filter_intents: z
                    ...
                    .describe('Comma-separated list of search intent codes: I=Informational, N=Navigational, T=Transactional, C=Commercial, L=Local.'),
                filter_multi_keyword_included: z
                    .string()
                    .optional()
                    .describe('Comma-separated list of words that MUST appear in the keyword (AND logic).'),
                filter_multi_keyword_excluded: z
                    .string()
                    .optional()
                    .describe('Comma-separated list of words that must NOT appear in the keyword.'),
            },
            annotations: this.annotations('read'),
        }, async (params) => this.makeGetRequest('/v1/keywords/questions', this.transformFilterParams(params)));
    }
}
//# sourceMappingURL=keywords-questions.js.map
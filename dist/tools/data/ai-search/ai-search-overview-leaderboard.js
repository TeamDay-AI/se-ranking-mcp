...
export class GetAiOverviewLeaderboard extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getAiOverviewLeaderboard'), {
            title: 'AI Search Comparison & Leaderboard (SE Ranking)',
            description: 'Data Tool: Compare multiple domains/brands in AI search engines (ChatGPT, Perplexity, Gemini, AI Overview, AI Mode). Use this for AI search comparison, competitor analysis, and visibility benchmarking. Returns brand presence, link presence, share of voice rankings, and leaderboard for each domain across AI engines.',
            inputSchema: {
                primary: TargetBrandSchema.describe('The primary target to analyze. Object with target (domain/subdomain/URL) and brand name.'),
                competitors: z
                    .array(TargetBrandSchema)
                    .min(1)
                    .max(10)
                    .describe('Array of competitor targets to compare against. Each object has target and brand. Maximum 10 competitors.'),
                source: z
                    .string()
                    .min(2)
                    .max(2)
                ...
                engines: z
                    ...
                    .min(1)
                    .describe("Array of AI engines to include in the analysis. Options: 'ai-overview', 'ai-mode', 'chatgpt', 'perplexity', 'gemini'."),
                scope: z
                    .enum(['domain', 'base_domain', 'url'])
                    .optional()
                    .describe('The scope of the analysis. Can be base_domain (domain and all subdomains), domain (specific host), or url (exact URL). Default: base_domain.'),
            },
...
//# sourceMappingURL=ai-search-overview-leaderboard.js.map
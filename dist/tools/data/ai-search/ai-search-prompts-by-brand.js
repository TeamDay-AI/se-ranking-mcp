...
export class GetAiPromptsByBrand extends BaseTool {
    registerTool(server) {
        server.registerTool(this.toolName('getAiPromptsByBrand'), {
            title: 'AI Search: Get Prompts by Brand (SE Ranking)',
            description: 'Data Tool: Retrieves a list of prompts where the specified brand is mentioned in AI search results.',
            inputSchema: {
                engine: z
                    .string()
                    .min(1, 'engine is required')
                    .describe("LLM to query (e.g., 'ai-overview', 'chatgpt', 'perplexity', 'gemini', 'ai-mode')."),
                brand: z
                    .string()
...
//# sourceMappingURL=ai-search-prompts-by-brand.js.map